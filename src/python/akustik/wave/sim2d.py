...
from akustik.diffusor.design import diffusor_bandwidth
from akustik.diffusor.qrd import quadratic_residue_diffuser
from akustik.diffusor.prd import primitive_root_diffuser
...
def main(
    ...
    if video:
        ...
        h5f = h5py.File(sim_dir / pathlib.Path('out.h5'), 'w')
